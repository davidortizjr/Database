                ...
                <form method="post">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" id="username" name="username" class="form-control"
                            value="<?php echo $editClient['username']; ?>" required>
                    </div>
                    <div class="form-group mb-3">
                        <label for="userInfoID">User Info ID</label>
                        <input type="text" id="userInfoID" name="userInfoID" class="form-control"
                            value="<?php echo $editClient['userInfoID']; ?>" required>
                    </div>
                    <div class="form-group mb-3">
                        <label for="email">Email</label>
                        <input type="email" id="email" name="email" class="form-control"
                            value="<?php echo $editClient['email']; ?>" required>
                    </div>
                    <div class="form-group mb-3">
                        <label for="phoneNumber">Phone Number</label>
                        <input type="text" id="phoneNumber" name="phoneNumber" class="form-control"
                            value="<?php echo $editClient['phoneNumber']; ?>" required>
                    </div>
